...
export const ComprehensiveMainContent: React.FC<ComprehensiveMainContentProps> = ({
  ...
  const renderContent = () => {
    ...
    if (selectedMenu === 'sales' || selectedMenu === 'sales-management' || 
        ...
        ['daily-sales', 'monthly-trends', 'yearly-reports', 'revenue-analytics', 'revenue-dashboard', 'sales-forecast', 'profit-margins', 'cost-analysis', 'roi-tracking', 'sales-reports', 'detailed-reports', 'summary-reports', 'performance-reports', 'comparative-analysis'].includes(selectedMenu)) {
      ...
      const submenu = ['daily-sales', 'monthly-trends', 'yearly-reports', 'revenue-analytics', 'revenue-dashboard', 'sales-forecast', 'profit-margins', 'cost-analysis', 'roi-tracking', 'sales-reports', 'detailed-reports', 'summary-reports', 'performance-reports', 'comparative-analysis'].includes(selectedMenu) 
        ? selectedMenu 
        : selectedSubmenu;
