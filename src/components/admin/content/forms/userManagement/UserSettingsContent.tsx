...
import { Settings, Bell, Shield, User, Globe, Mail } from 'lucide-react';
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Configure global user settings and preferences</p>
        </div>
        <Button>
      ...
      <Tabs defaultValue="general" className="space-y-4">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input defaultValue="UTC+6 (Asia/Dhaka)" />
                </div>
              </div>
        ...
        <TabsContent value="preferences" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">User preference settings would be configured here...</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
