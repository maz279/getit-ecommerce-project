  ...
  return (
    <section className="py-6 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-5 md:grid-cols-10 lg:grid-cols-20 gap-4 justify-items-center">
          {quickAccessItems.map((item, index) => (
            ...
            >
              <div className={`${item.color} transition-all duration-300 transform group-hover:scale-110 mb-2 p-2 rounded-full hover:shadow-md bg-gray-50 hover:bg-gray-100`}>
                {item.icon}
              </div>
