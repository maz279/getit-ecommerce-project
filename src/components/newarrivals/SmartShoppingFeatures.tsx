...
import { Brain, Bell, Globe, CreditCard, Search, Mic, Camera, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Our intelligent system learns from your behavior to suggest new arrivals you'll love. The more you shop, the better our recommendations become.",
