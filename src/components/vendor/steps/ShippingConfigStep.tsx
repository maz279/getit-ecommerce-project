  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">🚚 Shipping Configuration</h2>
        <p className="text-gray-600">We'll handle shipping and logistics for you</p>
      </div>

      {/* Shipping Partners */}
      <div>
        <h3 className="text-xl font-semibold mb-4">📦 Our Logistics Partners</h3>
