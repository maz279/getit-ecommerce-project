...
-- Advanced Inventory Management Tables (extending existing)
...
CREATE INDEX idx_smart_reorder_suggestions_vendor_id ON public.smart_reorder_suggestions(vendor_id);
