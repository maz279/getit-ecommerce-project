-- Phase 4: Enhanced Database Layer for Advanced Features & PWA (Fixed)
...
CREATE INDEX IF NOT EXISTS idx_enhanced_performance_metrics_user ON public.enhanced_performance_metrics(user_id, timestamp);
CREATE INDEX IF NOT EXISTS idx_enhanced_performance_metrics_resource ON public.enhanced_performance_metrics(resource_identifier, timestamp);
...
CREATE INDEX IF NOT EXISTS idx_cache_analytics_type ON public.cache_analytics(cache_type, created_at);
CREATE INDEX IF NOT EXISTS idx_cache_analytics_operation ON public.cache_analytics(operation, created_at);
CREATE INDEX IF NOT EXISTS idx_pwa_analytics_user ON public.pwa_analytics(user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_pwa_analytics_event ON public.pwa_analytics(event_type, created_at);
